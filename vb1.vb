Public Class Form1
    ...
    Dim hahnSpeed As Integer = 29
    Dim obstacleSpeed As Integer = 29
    ...
    Dim backgroundColors As New List(Of Color) From {Color.LightSkyBlue, Color.LightGreen, Color.LightPink, Color.LightYellow, Color.LightCoral}
    Dim obstacleColors As New List(Of Color) From {Color.Red, Color.Green, Color.Blue, Color.Yellow, Color.Purple}
    ...
    Private Sub InitializeGame()
        ...
        gameCompleted = False
        currentCheckpoint = 0
        checkpointColor = Color.LightSkyBlue
